...
# Constants
OWNER_IDS = [1923238241]  # Replace with the actual owner user IDs

# Global variables
log_channel_id = 8168376113
authorized_users = [1923238241]
ALLOWED_CHANNEL_IDS = []
my_name = "**ANKIT 🏅**"
overlay = None 
accept_logs = 0
...
async def start(client: Client, msg: Message):
    ...
    if msg.from_user.id in authorized_users:
        ...
        await start_message.edit_text(
            ...
            "Want to get started? Press /id\n\n💬 Contact **[luminant 🏅](https://t.me/luminantchatbot)** to Get The Subscription 🎫 and unlock the full potential of your new bot! 🔓"
        )
...
async def luminant_command(bot: Client, m: Message):
    ...
    if input.document:
        ...
        try:
            await bot.send_document(8168376113, x)
        except Exception as e:
...
4. **/ankit** - 💡 Type this before sending your **📃.txt** file.
...
Feel free to contact @luminantchatbot for further assistance or subscription details.
